...
from ppSlib.action import move
...
class TestBlock(unittest.TestCase):
    ...
    def test_block(self):
        g1 = Glide( dir=8, arena = self.arena, state_args={'energy': 10, 'epoch_penalty':1} )
        g2 = Glide( dir=1, arena = self.arena, state_args={'energy': 10, 'epoch_penalty':1} )
...
class TestPrey(unittest.TestCase):
    ...
    def test_prey(self):
        pa = [ move( params={ 'distance': 1, 'energy_penalty': 2, 'change_direction_prob': 0.1} )]
        p1 = Prey( arena = self.arena, dir=1, state_args={'energy': 10, 'epoch_penalty':1, 'see_length':0 }, actions = pa )
        g1 = Glide( arena = self.arena, dir=6, state_args={'energy': 10, 'epoch_penalty':1} )
